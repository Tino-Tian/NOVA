...
[**下载**](https://github.com/Tino-Tian/NOVA/releases) · [**功能**](#功能) · [**截图**](#截图)
...
从 [Releases](https://github.com/Tino-Tian/NOVA/releases) 下载最新 `.dmg`，打开后将 **NOVA** 拖入应用程序文件夹。

同时提供 Apple Silicon (arm64) 和 Intel (x86_64) 版本。应用已完成代码签名和公证，无需额外操作。

### Windows

从 [Releases](https://github.com/Tino-Tian/NOVA/releases) 下载 `.msi` 或 `.exe` 安装包并运行。要求 Windows 10 或更高版本。

### Linux

从 [Releases](https://github.com/Tino-Tian/NOVA/releases) 下载 `.AppImage`、`.deb` 或 `.rpm` 安装包。需要 WebKit2GTK。

> **国内用户：** 如果 GitHub 下载缓慢，可以从 [Gitee 镜像](https://gitee.com/Tino-Tian/NOVA/releases) 获取安装包。应用在检测更新时也会在 GitHub 不可达时自动降级到 Gitee。
